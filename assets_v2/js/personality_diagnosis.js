$(function () {
  ...
  const RESULT_DETAILS = {
    male: {
      1: { intro: "【真面目で責任感の強い男性】", pattern: "物事を正しいか正しくないかで判断しようとします。間違ったことや不正は許せません。理想の姿を求め、高い基準を設けて行動します。理性的であろうとし、秩序立てて物事を処理します。", attitude: "自立心の強い人ですが協調性もあります。誰に対しても平等公平で、嘘やごまかしがなく率直です。情に厚く、昔からの付き合いの友人を大切にします。", traits: "真面目で責任感が強く、自分に対して厳しい面があります。勤勉な努力家で、何事もきちんとしていないと気がすまず、完璧主義な面があります。", marriage: "恋愛・結婚についても真面目です。遊び半分のような交際をしません。夫婦は一生添い遂げるべきものと考え、多少の我慢と忍耐は必要だと思っています。", partner1Type: "タイプ６", partner1Rel: "常識があり、家庭のことをしっかり受け持ってくれる女性がふさわしいでしょう。協調性のある女性がおすすめです。", partner1App: "こだわりを述べるより、相手の方がリラックスできる雰囲気作りを。ユーモアを取り入れて緊張を解きましょう。", partner2Type: "タイプ４", partner2Rel: "情緒性があり、フェミニンなやさしさのある女性。日々の生活に潤いをもたらすパートナーが合っています。", partner2App: "お相手の趣味や好みを尋ねてみましょう。お互いの感覚が合いそうかじっくり感じ取ってください。", failFactor: "お相手に対して厳しい基準をお持ちのようです。欠点に目を向けがちでパーフェクトを求めすぎていませんか？", advice: "「こうでなければならない」を一度手放し、相手のいいところに目を向けましょう。ポジティブな見方が運命を変えます。" },
      2: { intro: "【やさしく思いやりのある男性】", pattern: "理屈よりも気持ちを大切にする人です。物事の見通しは楽観的でポジティブ。ネガティブな感情は表に出しません。", attitude: "協調性があり周りを気遣います。自分から人に親切にし、喜ばせることを好みます。困っている人を放っておけません。", traits: "親切で思いやりのある人です。人から必要とされ、役に立てることに喜びを感じます。世話好きでお人よしな面があります。", marriage: "愛する人のために尽くすタイプ。好きな人の喜びが自分の喜びになります。家庭では家族との時間を大切にします。", partner1Type: "タイプ２", partner1Rel: "同じように温かいハートを持っている女性がおすすめ。笑顔を絶やさない家庭的な方と仲良くなれるでしょう。", partner1App: "友達止まりになりがちです。ストレートに結婚生活の夢や、理想の家庭イメージなどを具体的に話し合いましょう。", partner2Type: "タイプ４", partner2Rel: "内気で繊細、傷つきやすそうな女性に魅力を感じるはず。趣味のいいものに囲まれた暮らしを好む方と合います。", partner2App: "相手の気持ちに寄り添い、理解しようとする姿勢を見せてください。気まぐれな態度も温かく受け止めてあげましょう。", failFactor: "やさしさが「誰にでも親切」と思われたり、問題を抱えた女性を支えようとしすぎる面があります。", advice: "やさしさだけでなく男らしさも強調しましょう。相手が話したくなるまで待つ心の余裕も大切です。" },
      3: { intro: "【野心的で行動力のある男性】", pattern: "合理的に割り切った考えができる人。現実的に物事を受け止め、最短距離でやり遂げようとする効率重視派です。", attitude: "第一印象を大切にし、自分をアピールするのが得意。チームではリーダーシップを発揮し、人脈作りに積極的です。", traits: "価値ある人間でありたいという気持ちが強い人です。実力が認められ評価されることを望みます。競争心も強いです。", marriage: "カッコよく見られるよう外見に気を配ります。結婚は現実的に考え、良い条件を比較して選ぶ割り切りができる人です。", partner1Type: "タイプ３", partner1Rel: "華のある魅力的な女性に惹かれるでしょう。積極的でテキパキした方となら価値観を共有できるはずです。", partner1App: "自信を持って行動しましょう。あなたが抱いている野心や仕事への熱意を伝えると相手も頼もしく感じます。", partner2Type: "タイプ７", partner2Rel: "社交性があって元気で明るい女性。家の中を明るくし、休日を一緒に楽しめるパートナーになります。", partner2App: "お互いに社交的なのですぐ親しくなれます。デートの誘いもためらわず、ともに行動することで進展します。", failFactor: "格好をつけようとして見栄を張ったり自慢話をしたりしがちです。それがマイナス印象にならないよう注意を。", advice: "理想を演じるより自然体で接しましょう。普段着でデートできるようなリラックス感が結婚への近道です。" },
      ...
      6: { intro: "【誠実で義務を果たせる男性】", pattern: "規則や秩序を重んじ、用意周到です。危機管理意識が高く慎重ですが、有事には誰よりも勇敢に行動します。", attitude: "協調性があり組織の一員としての誇りを持ちます。上下関係を意識し、誠実な仲間付き合いをします。", traits: "責任感が強く几帳面。ルールに従いコツコツと進めるのが得意な、信頼できる人です。", marriage: "男らしさにこだわり保守的です。親戚付き合いも考え身元のしっかりした人を求めます。甘えたい面も。", partner1Type: "タイプ２", partner1Rel: "明るく家庭的な女性がおすすめ。親戚付き合いも丁寧にしてくれる方となら、温かい家庭を築けそうです。", partner1App: "相手が自分に好意を持ってくれているのか、遠慮せず率直な気持ちを尋ねてみましょう。将来設計も話して。", partner2Type: "タイプ７", partner2Rel: "社交的で楽天的な女性がおすすめ。風通しのいい家庭になり、あなたの考えすぎを和らげてくれるでしょう。", partner2App: "一緒にいて楽しいと思ってもらうのが第一。トレンドの場所へデートに誘い、リズムを合わせましょう。", failFactor: "好意を抱いた相手に対してもすぐ迷いが生じ、決断のタイミングを逃してしまうことがありそうです。", advice: "価値観の違いは当然と受け止めましょう。迷いは心に留めず、相手と向き合って対話を大切にしてください。" },
      7: { intro: "【楽天的で好奇心旺盛な男性】", pattern: "何事もいい方に解釈し、次々と計画を立てます。活発でじっとしておらず、思い立ったら即実行します。", attitude: "明るく社交的。誰とでもすぐ親しくなり、場を盛り上げて周りを元気づけます。付き合いは広く浅い方です。", traits: "前向きで切り替えが早いです。呑み込みが早く器用なので、複数のことを並行してこなせます。", marriage: "付き合って楽しい人が一番。フィーリング重視で、意気投合すれば即決する傾向があります。", partner1Type: "タイプ１", partner1Rel: "真面目な常識人の女性がいいでしょう。外に向かいがちなあなたを、家庭でしっかり繋ぎ止めてくれます。", partner1App: "楽しい話だけでなく現実に即した将来の話を。ころころ話題を変えず、相手の話をじっくり聞く姿勢も重要。", partner2Type: "タイプ３", partner2Rel: "積極的で行動的な女性。エネルギーが釣り合い、仕事も遊びも意欲的な二人で会話が弾む相性です。", partner2App: "自分の実績を遠慮せず話しましょう。相手はスペックも気にしています。魅力的なところを褒めてあげて。", failFactor: "束縛を嫌い、結婚に踏み切るのが惜しくなることが。目移りしやすいあなたに女性もためらうかもしれません。", advice: "「明るい家庭を築けそう」と思わせるアピールを。今目の前の方とじっくり向き合う時間を作ってください。" },
    ...
    female: {
      ...
      5: { intro: "【物静かで控えめ、思慮深い女性】", pattern: "冷静に物事を受け止め、納得するまで調べます。準備に時間をかける集中力の高いタイプです。", attitude: "大勢の集まりが苦手。独自の知識を大切にし、自分から積極的に関わりません。傍で眺めるタイプ。", traits: "内向的で感情を表に出しません。独自の賢明な視点を持ち、一人の時間を大切にする知的な人です。", marriage: "「愛とは何か」を深く考える人。結婚後も、自分一人になれる場所と時間を必要とします。", partner1Type: "タイプ５", partner1Rel: "同じように物静かで知的な方がおすすめ。尊敬し合える居心地いい家庭になります。", partner1App: "共通の趣味などから話を広げましょう。メール等をタイミングよく活用するのがポイントです。", partner2Type: "タイプ６", partner2Rel: "まじめで堅実な男性もお勧めです。家庭を大切にする相手なら、将来を安心して預けられます。", partner2App: "家族の話なども織り交ぜて安心感を与えましょう。お相手はあなたがどんな人か知りたがっています。", failFactor: "「何を考えているかわからない」と思われやすく、コミュニケーション不足になりがちです。", advice: "言葉数を増やす工夫を。「はい」だけでなく代わりの提案をするなど、話を繋げる意識を。" },
      ...
      8: { intro: "【元気ではつらつとした女性】", pattern: "決断力と実行力があり意思が強い。考えるよりも行動が先に出るエネルギッシュな人です。", attitude: "ストレートに自分を主張します。自立心が強く、頼られると放っておけない親分肌です。", traits: "パワフルで裏表がありません。困難を恐れず、どんな状況でもへこたれない強さを持っています。", marriage: "好きになったらストレート。この人ならと思える人に出会った時に結婚を決断します。", partner1Type: "タイプ８", partner1Rel: "同じように野心的な男性がおすすめ。男勝りなあなたを尊重してくれる良きパートナーになります。", partner1App: "初対面は強がってぎこちないかも。でも話し始めればホンネでぶつかっても大丈夫な相手です。", partner2Type: "タイプ９", partner2Rel: "温厚な方もお勧め。どっしり構えた相手なら、あなたの短気をなだめ、リラックスさせてくれます。", partner2App: "相手は積極的ではないので、あなたが主導権を握り、はっきり意思表示をしましょう。", failFactor: "自立心が強すぎて甘えるのが苦手。葛藤が生じると自分から関係を断つことがあります。", advice: "適度な甘えと忍耐が必要です。少しのことは大目に見、話し合えば信頼はさらに深まります。" },
      9: { intro: "【穏和な癒し系の女性】", pattern: "楽観的でめったに慌てません。ゆったりした時間感覚を持ち、平和で心地よい空気を好むマイペース派。", attitude: "受け身的で誰でも受け入れます。黙ってうなずき、場を和ませる温かい雰囲気があります。", traits: "素朴で飾らず、平穏な暮らしを望みます。ふだんは温厚ですが、頑固に譲らない面も。", marriage: "恋も受け身。相手からのアプローチを優先し、パートナーと一体化する感じを持ちます。", partner1Type: "タイプ８", partner1Rel: "力強く行動的な男性がおすすめ。背中を押して引っ張ってくれる相手となら、活気ある生活が送れます。", partner1App: "相手は「はっきり言ってほしい」タイプ。些細なことでも自分の意思表示をしましょう。", partner2Type: "タイプ９", partner2Rel: "同じく穏やかな方も。時間はかかりますが絆は深くなり、オシドリ夫婦のようになれるでしょう。", partner2App: "両方受け身なので、あなたからアプローチを。希望を伝えないと話が進展しません。", failFactor: "自信を持てず消極的。乗り気でない相手からの誘いを断れないこともあります。", advice: "ファッションや趣味を充実させ自信を。意思表示で自分の気持ちを守れるようになります。" }
    }
  };
  ...
  function prepareContents() {
    const QUESTION_LIST = [
      ...
      { no: "08", question: "友人や恋人と話をしているときは……", answer1: "自分が話していることが多く、よく「わたしは」という主語を使う。", answer2: "自分は聞き役に回り、人がしゃべっているのを聞くことが多い。", answer3: "相手の反応を気にしながら話し、譲り合う。", answer1Type: "a", answer2Type: "c", answer3Type: "b" },
